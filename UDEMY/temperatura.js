...
const convertir = document.getElementById('sapito');
...
const convertir_t = document.getElementById('sapito');
const hola_t = document.getElementById('respuesta');

function tiapaola(result) {
    const temperature = grades.value;
